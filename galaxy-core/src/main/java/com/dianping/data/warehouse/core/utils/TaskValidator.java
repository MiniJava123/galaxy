...
import com.dianping.data.warehouse.core.common.CoreConst;
...
public class TaskValidator {
    ...
    private static String[] validateFreq(String freq){
        boolean flag = true;
        flag = CronExpression.isValidExpression(freq);
        String[] rtn = new String[2];
        rtn[0] = flag ? "1" : "0";
        if(!flag){
            rtn[1] = "freq "+freq +" is illegal";
        }
        return rtn;
    }
...
//    }
    ...
    public static String[] validateTask(TaskDO task){
        StringBuilder builder = new StringBuilder();
        String[] rtn1=null,rtn2=null,rtn3=null,rtn4=null,rtn5=null,rtn6=null,rtn7=null,rtn8=null;
        try{
            ...
            rtn7 = validateCycle(task.getCycle());
            rtn8 = validateFreq(task.getFreq());
        }catch(Exception e){
